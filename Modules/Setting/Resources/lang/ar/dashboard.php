...
return [
    'settings' => [
        'form' => [
            ...
            'status' => 'الحالة',
            'fast_delivery_message' => 'رسالة التوصيل السريع',
            'orders' => 'الطلبات',
            'min_price' => 'الحد الأدني للطلبات',
            'fast_delivery_hours_preparation_time' => 'وقت التحضير (بالساعات) فى حالة التوصيل السريع',
            'usual_delivery_hours_preparation_time' => 'وقت التحضير (بالساعات) فى حالة التوصيل المعتاد',
            ...
            'loyalty_points' => [
                'title' => 'نقاط الولاء',
                'balance_title' => 'نقاط الولاء (لحساب الرصيد)',
                'fils_count' => 'عدد الفلسات',
            ...
            'tabs' => [
                ...
                'products' => 'المنتجات',
                'order_status' => 'حالات التوصيل',
                'custom_codes' => 'Custom Codes',
                'order_status_colors' => 'ألوان حالات التوصيل',

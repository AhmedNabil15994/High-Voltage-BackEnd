...
return [
    'settings' => [
        'form' => [
            ...
            'status' => 'Status',
            'fast_delivery_message' => 'Fast Delivery Message',
            'orders' => 'Orders',
            'min_price' => 'Minimum order price',
            'fast_delivery_hours_preparation_time' => 'Preparation time (in hours) for express delivery',
            'usual_delivery_hours_preparation_time' => 'Preparation time (in hours) in the case of regular delivery',
            ...
            'loyalty_points' => [
                ...
                'balance_title' => 'Loyalty Points (to calculate balance)',
                'fils_count' => 'Fils Count',

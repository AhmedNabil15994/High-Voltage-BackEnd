            ...
            @foreach (config('translatable.locales') as $code)
                <div id="first_{{ $code }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="app_address[{{ $code }}]"
                                value="{{ config('setting.app_address.' . $code) }}" />
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-md-2">
                            {{ __('setting::dashboard.settings.form.fast_delivery_message') }} - {{ $code }}
                        </label>
                        <div class="col-md-9">
                            <input type="text" class="form-control"
                                name="fast_delivery_message[{{ $code }}]"
                                value="{{ config('setting.fast_delivery_message.' . $code) }}" />
                        </div>
                    </div>

...
@section('title', __('baqat::dashboard.baqat.routes.update'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{ __('baqat::dashboard.baqat.routes.update') }}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post"
                    enctype="multipart/form-data" action="{{ route('dashboard.baqat.update', $baqa->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                                ...
                                <div class="tab-pane active fade in" id="global_setting">
                                    <div class="col-md-10">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="title[{{ $code }}]"
                                                                ...
                                                                value="{{ $baqa->getTranslation('title', $code) }}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea name="description[{{ $code }}]" rows="4" class="form-control"
                                                                data-name="description.{{ $code }}">{{ $baqa->getTranslation('description', $code) }}</textarea>
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text"
                                                                ...
                                                                value="{{ $baqa->getTranslation('duration_description', $code) }}">
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" name="duration_by_days" class="form-control"
                                                    data-name="duration_by_days" value="{{ $baqa->duration_by_days }}">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="checkbox" class="make-switch" id="status" data-size="small"
                                                    name="status" {{ $baqa->status == 1 ? ' checked="" ' : '' }}>
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                        ...
                                        @if ($baqa->trashed())
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{ __('baqat::dashboard.baqat.form.restore') }}
                                                </label>
                                                <div class="col-md-9">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" step="0.1" min="0" name="price"
                                                    class="form-control" data-name="price" value="{{ $baqa->price }}">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" step="0.1" min="0" name="client_price"
                                                       class="form-control" data-name="client_price" value="{{ $baqa->client_price }}">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="checkbox" class="make-switch" id="offerStatusCheckbox"
                                                    ...
                                                    {{ optional($baqa->offer)->status == 1 ? ' checked="" ' : '' }}>
                                                <div class="help-block"></div>
                                            </div>
                                        </div>

                                        <div class="offer-form"
                                            style="display: {{ optional($baqa->offer)->status == 1 ? 'block' : 'none' }}">
                                                    ...
                                                    <div class="mt-radio-inline">
                                                        <label class="mt-radio">
                                                            <input type="radio" name="offer_type"
                                                                ...
                                                                {{ is_null($baqa->offer) || optional($baqa->offer)->offer_price ? 'checked' : '' }}>
                                                        ...
                                                        <label class="mt-radio">
                                                            <input type="radio" name="offer_type"
                                                                ...
                                                                {{ !is_null($baqa->offer) && optional($baqa->offer)->percentage ? 'checked' : '' }}>
                                            ...
                                            <div class="form-group" id="offerAmountSection"
                                                style="display: {{ is_null($baqa->offer) || optional($baqa->offer)->offer_price ? 'block' : 'none' }}">
                                                <label class="col-md-2">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="number" step="0.1" min="0" id="offer-form"
                                                        ...
                                                        value="{{ optional($baqa->offer)->offer_price ?? '' }}">
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>

                                            <div class="form-group" id="offerPercentageSection"
                                                style="display: {{ !is_null($baqa->offer) && optional($baqa->offer)->percentage ? 'block' : 'none' }}">
                                                <label class="col-md-2">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="number" step="0.1" min="0"
                                                        ...
                                                        value="{{ optional($baqa->offer)->percentage ?? '' }}">
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group input-medium date date-picker"
                                                        ...
                                                        <input type="text" id="offer-form" class="form-control"
                                                            ...
                                                            value="{{ optional($baqa->offer)->start_at ?? '' }}">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group input-medium date date-picker"
                                                        ...
                                                        <input type="text" id="offer-form" class="form-control"
                                                            ...
                                                            value="{{ optional($baqa->offer)->end_at ?? '' }}">
                                                        <span class="input-group-btn">
                                                            <button class="btn default" type="button">
                                                                <i class="fa fa-calendar"></i>
                                                            </button>

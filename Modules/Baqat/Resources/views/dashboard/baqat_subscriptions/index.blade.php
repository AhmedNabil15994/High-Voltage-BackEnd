...
@section('title', __('baqat::dashboard.baqat_subscriptions.routes.index'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('baqat::dashboard.baqat_subscriptions.routes.index')}}</a>
                    </li>
                </ul>
            </div>
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.baqat_subscriptions.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },

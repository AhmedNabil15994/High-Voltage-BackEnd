...
@section('title', __('baqat::dashboard.baqat_subscriptions.routes.current_index'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('baqat::dashboard.baqat_subscriptions.routes.current_index')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light bordered">
                        ...
                        @permission('add_baqat_subscriptions')
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{ url(route('dashboard.baqat_subscriptions.create')) }}"
                                                ...
                                                <div class="form-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="control-label">
                                                                    {{__('baqat::dashboard.baqat_subscriptions.datatable.user')}}
                                                                </label>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="control-label">
                                                                    {{__('baqat::dashboard.baqat_subscriptions.datatable.baqa')}}
                                                                </label>
                        ...
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                {{__('baqat::dashboard.baqat_subscriptions.routes.current_index')}}
                            </span>
                            </div>
                        </div>
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>{{__('baqat::dashboard.baqat_subscriptions.datatable.user')}}</th>
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.baqat_subscriptions.current_datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },

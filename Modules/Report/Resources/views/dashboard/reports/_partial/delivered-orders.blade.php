...
@section('title', __('report::dashboard.reports.index.form.delivered_orders.title'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{ __('report::dashboard.reports.index.form.delivered_orders.title') }}</a>
                    </li>
                </ul>
            </div>
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="control-label">
                                                                    {{ __('report::dashboard.reports.index.form.delivered_orders.form.payment_status') }}
                                                                </label>
                                                                <div class="mt-radio-list">
                                                                    <label class="mt-radio">
                                                                        {{ __('report::dashboard.reports.index.form.delivered_orders.form.paid') }}
                                                                        <input type="radio" value="paid"
                                                                            name="payment_status" />
                                                                        <span></span>
                                                                    </label>
                                                                    <label class="mt-radio">
                                                                        {{ __('report::dashboard.reports.index.form.delivered_orders.form.unpaid') }}
                        ...
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">
                                    {{ __('report::dashboard.reports.index.form.delivered_orders.title') }}
                                </span>
                            </div>
                        </div>
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.reports.delivered_orders.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                ...
                                var buttons = `
                                        ...
                                        `;
                                // if (full.order_status_id != 8) { // is_ready

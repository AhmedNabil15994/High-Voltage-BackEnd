                      ...
                      <div class="main-menu">
                          <nav id="mobile-menu">
                              <ul>
                                  ...
                                  <li><a href="{{ route('frontend.offers.index') }}">{{ __('Offers') }}</a></li>
                                  <li><a href="{{ route('frontend.contact_us') }}">{{ __('Contact Us') }}</a></li>
                              </ul>
                          </nav>
                      </div>
                  </div>
                  <div class="col-xl-6 d-none d-xl-block d-lg-block my-auto col-lg-6">
                      <div class="header-info-right">
                          ...
                          @if (auth()->check())
                              ...
                              <!--
                                <div class="header-lang">
                                    <div class="lang-icon">
                                        <a href="#0" class="site-btn font-lang"> تسجيل <span class="icon"><i class="fal fa-user-unlock"></i></span></a>
                                    </div>
                                    <ul class="header-lang-list">
                                        <li><a href="login.php"><i class="fal fa-user-unlock"></i> تسجيل دخول</a></li>
                                        <li><a href="register.php"><i class="fal fa-user-plus"></i> مستخدم جديد</a></li>
                                    </ul>
                                </div>
                            -->
                          @else
                              ...
                              @if (auth()->check())
                                  ...
                                  <div class="header-button-list header-lang">
                                      ...
                                      <ul class="header-lang-list">
                                          ...
                                          <li>
                                              <a href="login.php"><i class="fal fa-arrow-alt-to-left"></i>
                                                  {{ __('Log Out') }}</a>
                                          </li>
                                      </ul>
                                  </div>
                                  ...
                                  <!--
                                    <div class="header-button-list header-lang">
                                        <div class="lang-icon">
                                            <a href="#0" class="btn font-lang"><i class="fal fa-user-unlock"></i></a>
                                        </div>
                                        <ul class="header-lang-list">
                                            <li><a href="login.php"><i class="fal fa-user-unlock"></i> تسجيل دخول</a></li>
                                            <li><a href="register.php"><i class="fal fa-user-plus"></i> مستخدم جديد</a></li>

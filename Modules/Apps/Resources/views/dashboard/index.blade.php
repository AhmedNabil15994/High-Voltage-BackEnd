        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 blue" href="{{route('dashboard.users.index')}}">
                        <div class="visual">
                        </div>
                        <div class="details">
                            <div class="number">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 yellow-casablanca" href="{{route('dashboard.completed_orders.index')}}?from={{date('Y-m-d')}}&to={{date('Y-m-d')}}">
                        <div class="visual">
                            <i class="fa fa-bar-chart-o"></i>
                        </div>
                        <div class="details">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 yellow-lemon" href="{{route('dashboard.completed_orders.index')}}?from={{date('Y-m-01')}}&to={{date('Y-m-t')}}">
                        <div class="visual">
                            <i class="fa fa-bar-chart-o"></i>
                        </div>
                        <div class="details">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <a class="dashboard-stat dashboard-stat-v2 yellow-gold" href="{{route('dashboard.completed_orders.index')}}?from={{date('Y-01-01')}}&to={{date('Y-12-31')}}">
                        <div class="visual">
                            <i class="fa fa-bar-chart-o"></i>
                        </div>
                        <div class="details">

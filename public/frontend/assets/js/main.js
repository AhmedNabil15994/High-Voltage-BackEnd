(function ($) {
    ...
    $('#cbox2').on('click', function () {
        $('#cbox_info2').slideToggle(900);
    });
    // Create an account toggle function
    $('#cbox3').on('click', function () {
        $('#cbox_info3').slideToggle(900);
    });
...
$(document).ready(function () {
    ...
    $(document).on('click', '.count2 .plus', function () {
        $('#count2').val(parseInt($('#count2').val()) + 1);
    });
    $(document).on('click', '.count2 .minus', function () {
        $('#count2').val(parseInt($('#count2').val()) - 1);
        if ($('#count2').val() == 0) {
            $('#count2').val(1);
        }
    ...
    $(document).on('click', '.count3 .plus', function () {
        $('#count3').val(parseInt($('#count3').val()) + 1);
    });
    $(document).on('click', '.count3 .minus', function () {
        $('#count3').val(parseInt($('#count3').val()) - 1);
        if ($('#count3').val() == 0) {
            $('#count3').val(1);
        }

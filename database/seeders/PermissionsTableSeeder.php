...
class PermissionsTableSeeder extends Seeder
{
    ...
    private $permissions = [
        ...
        'order_statuses' => [
            'display_name' => ['ar' => 'حالات التوصيل', 'en' => 'order statuses'],
            'single' => false,
        ],
        'orders' => [
        ...
        'baqat' => [
            'display_name' => ['ar' => 'الباقات', 'en' => 'Packages (Baqat)'],
            'single' => false,
        ],
        'baqat_subscriptions' => [
            'display_name' => ['ar' => 'اشتراكات الباقات', 'en' => 'Packages (Baqat) Subscriptions'],
            'single' => false,
        ],
        ...
        'show_working_times' => [
            'category' => ['ar' => 'وقت الإستلام والتوصيل', 'en' => 'pick-up and delivery times'],
            'single' => true,
            'name' => 'show_working_times',
            'display_name' => [
                'en' => 'Show Pick-up and Delivery Times',
                'ar' => 'عرض وقت الإستلام والتوصيل',
            ],
        ],
        ...
        'show_order_change_status_tab' => [
            ...
            'display_name' => [
                ...
                "ar" => "عرض نافذة تغيير حالة التوصيل",
